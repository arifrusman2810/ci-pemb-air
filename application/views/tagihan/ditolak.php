...
<section class="content">
  <div class="box">
    <div class="box-header">
      <h3 class="box-title"><span class="label label-danger">Pembayaran Ditolak</span></h3>
    </div>
      ...
      <table class="table table-bordered table-striped" id="table1">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="<?= site_url('tagihan/detailTolak/'.$data->id_tagihan) ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Detail</a>
            </td>
          </tr>
          <?php endforeach; ?>
        </tbody>
