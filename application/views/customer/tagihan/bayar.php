          ...
          <div class="table-responsive">
            <table class="table table-striped">
              <tbody>
                ...
                <tr>
                  <?php 
                  $total_bayar = ($tagihan->tagihan + 3500 + 4000) - $total_refund
                  ?>
            ...
            <form action="<?= site_url('customer/tagihan/bayarProcess') ?>" method="POST" enctype="multipart/form-data">
              ...
              <?php if($tagihan->status == 'Belum Bayar'): ?>
                ...
                <div class="form-group">
                  ...
                  <a href="<?= site_url('customer/tagihan/belumBayar') ?>" class="btn btn-warning btn-flat"> Kembali</a>
                </div>
              <?php endif; ?>
            </form>
          </div>
